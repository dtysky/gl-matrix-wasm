 ...
 */
pub fn distance(a: &Vector4, b: &Vector4) {
  let x = b.0 - a.0;
  let y = b.1 - a.1;
  let z = b.2 - a.2;
  let w = b.3 - a.3;
  return f32::hypot(x, y, z, w);
}
 ...
 */
pub fn squaredDistance(a: &Vector4, b: &Vector4) {
  let x = b.0 - a.0;
  let y = b.1 - a.1;
  let z = b.2 - a.2;
  let w = b.3 - a.3;
 ...
 */
pub fn squaredLength(a: &Vector4) {
  let x = a.0;
  let y = a.1;
  let z = a.2;
  let w = a.3;
 ...
 * @returns {vec4} result
 */
pub fn cross(result: &Vector4, U: &Vector4, V: &Vector4, W: &Vector4) {
 ...
 * @returns {vec4} out
 */
pub fn random(out: &mut Vector4, scale: f32) {
  scale = scale || 1.0;
 ...
 * @returns {Boolean} True if the vectors are equal, false otherwise.
 */
pub fn equals(a: &Vector4, b: &Vector4) {
  let a0=a.0;
let a1=a.1;
let a2=a.2;
let a3=a.3;
 ...
 * @function
 */
pub fn dist(out: &mut Vector4, a: &Vector4, b: &Vector4) {
  Vector4::distance(out, a, b);
}
 ...
 * @function
 */
pub fn sqrDist(out: &mut Vector4, a: &Vector4, b: &Vector4) {
  Vector4::squaredDistance(out, a, b);
}
 ...
 * @function
 */
pub fn len(out: &mut Vector4, a: &Vector4, b: &Vector4) {
  Vector4::length(out, a, b);
}
