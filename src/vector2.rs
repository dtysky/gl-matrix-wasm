 ...
 */
pub fn distance(a: &Vector2, b: &Vector2) {
  let x=b.0-a.0;
let y=b.1-a.1;
  return f32::hypot(x, y);
}
 ...
 */
pub fn squaredDistance(a: &Vector2, b: &Vector2) {
  let x=b.0-a.0;
let y=b.1-a.1;
  return x*x + y*y;
}
 ...
 */
pub fn squaredLength(a: &Vector2) {
  let x=a.0;
let y=a.1;
  return x*x + y*y;
}
 ...
 */
pub fn angle(a: &Vector2, b: &Vector2) {
  let x1=a.0;
let y1=a.1;
let x2=b.0;
let y2=b.1;
 ...
 */
pub fn exactEquals(a: &Vector2, b: &Vector2) {
  return a.0 == b.0 && a.1 == b.1;
}
 ...
 * @returns {Boolean} True if the vectors are equal, false otherwise.
 */
pub fn equals(a: &Vector2, b: &Vector2) {
  let a0=a.0;
let a1=a.1;
  let b0=b.0;
let b1=b.1;
 ...
 * @function
 */
pub fn len(out: &mut Vector2, a: &Vector2, b: &Vector2) {
  Vector2::length(out, a, b);
}
 ...
 * @function
 */
pub fn dist(out: &mut Vector2, a: &Vector2, b: &Vector2) {
  Vector2::distance(out, a, b);
}
 ...
 * @function
 */
pub fn sqrDist(out: &mut Vector2, a: &Vector2, b: &Vector2) {
  Vector2::squaredDistance(out, a, b);
}
 ...
 * @function
 */
pub fn sqrLen(out: &mut Vector2, a: &Vector2, b: &Vector2) {
  Vector2::squaredLength(out, a, b);
}
}
