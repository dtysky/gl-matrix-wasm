...
describe("mat3", function() {
    ...
    let vec3: typeof import('../pkg/gl_matrix_wasm').Vector3, mat3: typeof import('../pkg/gl_matrix_wasm').Matrix3, mat4, vec2, quat;

    before(done => {
        import('../pkg/gl_matrix_wasm').then(({Vector3, Matrix3, Matrix4, Vector2, Quaternion}) => {
            vec2 = Vector2;
            vec3 = Vector3;
            mat3 = Matrix3;
            mat4 = Matrix4;
