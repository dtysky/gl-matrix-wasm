...
describe("vec4", async function () {
    let vec4;
    let out, vecA, vecB, result;

    before(done => {
        import('../pkg/gl_matrix_wasm').then(({Vector4}) => {
            vec4 = Vector4;
            done();
        });
    });
    ...
    describe("ceil", function () {
        beforeEach(function () { vecA = vec4.fromValues(Math.E, Math.PI, Math.SQRT2, Math.SQRT1_2); });
    ...
    describe("min", function () {
        beforeEach(function () { vecA = vec4.fromValues(1, 3, 1, 3); vecB = vec4.fromValues(3, 1, 3, 1); });
    ...
    describe("normalize", function () {
        beforeEach(function () { vecA = vec4.fromValues(5, 0, 0, 0); });
    ...
    describe("exactEquals", function () {
        let vecC, r0, r1;
        beforeEach(function () {
            vecA = vec4.fromValues(0, 1, 2, 3);
            vecB = vec4.fromValues(0, 1, 2, 3);
            vecC = vec4.fromValues(1, 2, 3, 4);
    ...
    describe("equals", function () {
        ...
        beforeEach(function () {
            ...
            vecB = vec4.fromValues(0, 1, 2, 3);
            vecC = vec4.fromValues(1, 2, 3, 4);
            vecD = vec4.fromValues(1e-16, 1, 2, 3);
