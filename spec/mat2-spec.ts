...
describe("mat2", function() {
    ...
    beforeEach(function() {
        matA = mat2.fromValues(1, 2,
                3, 4);

        matB = mat2.fromValues(5, 6,
                7, 8);

        out =  mat2.fromValues(0, 0,
                0, 0);

        identity = mat2.fromValues(
            1, 0,
            0, 1
        );
    });
   ...
   describe("LDU", function() {
        ...
        beforeEach(function() {
            ...
            D = mat2.create();
            U = mat2.create();
            mat2.LDU(L, D, U, mat2.fromValues(4,3,6,3));
        ...
        it("should return a lower triangular, a diagonal and an upper triangular matrix", function() {
            expect(L).toBeEqualish(L_result);
            expect(D).toBeEqualish(D_result);
            expect(U).toBeEqualish(U_result);
        });
   });
    ...
    describe("exactEquals", function() {
        let matC, r0, r1, r2;
        beforeEach(function() {
            matA = mat2.fromValues(0, 1, 2, 3);
            matB = mat2.fromValues(0, 1, 2, 3);
            matC = mat2.fromValues(1, 2, 3, 4);
    ...
    describe("equals", function() {
        ...
        beforeEach(function() {
            ...
            matB = mat2.fromValues(0, 1, 2, 3);
            matC = mat2.fromValues(1, 2, 3, 4);
            matD = mat2.fromValues(1e-16, 1, 2, 3);
