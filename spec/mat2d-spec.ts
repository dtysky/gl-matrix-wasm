...
describe("mat2d", function() {
    let vec2: typeof import('../pkg/gl_matrix_wasm').Vector2, mat2d: typeof import('../pkg/gl_matrix_wasm').Matrix2d;
    let out, matA, matB, oldA, oldB, identity, result;

    before(done => {
        import('../pkg/gl_matrix_wasm').then(({Vector2, Matrix2d}) => {
            vec2 = Vector2;
            mat2d = Matrix2d;
            done();
        });
    ...
    beforeEach(function() {
        matA = mat2d.fromValues(1, 2,
                3, 4,
                5, 6);

        oldA = mat2d.fromValues(1, 2,
                3, 4,
                5, 6);

        matB = mat2d.fromValues(7, 8,
                9, 10,
                11, 12);

        oldB = mat2d.fromValues(7, 8,
                9, 10,
                11, 12);

        out = mat2d.fromValues(0, 0,
                0, 0,
                0, 0);

        identity = mat2d.fromValues(1, 0,
                    0, 1,
                    0, 0);
    });
    ...
    describe("scale", function() {
        let vecA;
        beforeEach(function() { vecA = vec2.fromValues(2, 3); });
   ...
   describe("frob", function() {
    ...
    describe("exactEquals", function() {
        let matC, r0, r1;
        beforeEach(function() {
            matA = mat2d.fromValues(0, 1, 2, 3, 4, 5);
            matB = mat2d.fromValues(0, 1, 2, 3, 4, 5);
            matC = mat2d.fromValues(1, 2, 3, 4, 5, 6);
    ...
    describe("equals", function() {
        ...
        beforeEach(function() {
            ...
            matB = mat2d.fromValues(0, 1, 2, 3, 4, 5);
            matC = mat2d.fromValues(1, 2, 3, 4, 5, 6);
            matD = mat2d.fromValues(1e-16, 1, 2, 3, 4, 5);
